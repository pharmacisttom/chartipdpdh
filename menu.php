            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-gradient-info py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="recorder.php">ข้อมูลผู้ติดตามchart</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-gradient-success py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="datachartipdline.php">การติดตามchart</a>
                        <!-- <a class="collapse-item" href="14.php">ติดตาม 14 วัน</a>
                        <a class="collapse-item" href="30.php">ติดตาม 30 วัน</a>
                        <a class="collapse-item" href="60.php">ติดตาม 60 วัน</a>
                        <a class="collapse-item" href="120.php">ติดตาม 120 วัน</a> -->
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-gradient-info py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="uncomdoctor.php">การลงข้อมูลไม่ครบส่วนแพทย์</a>
                        <a class="collapse-item" href="#">การลงข้อมูลไม่ครบส่วนเคลม</a>
